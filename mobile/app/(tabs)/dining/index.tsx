...
export default function DiningScreen() {
  ...
  // Always use the current meal period so "Now" is always fresh and accurate.
  const effectivePeriod = hallStatus?.current_meal_period ?? undefined;

  const { data, isLoading, error } = useDiningRecommendations(selectedHall, effectivePeriod);
